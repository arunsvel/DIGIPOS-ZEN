    ...
    public partial class frmSalesReturnReport : Form
    {
        ...
        private void txtVoucherTypeList_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (this.ActiveControl.Name != "txtVoucherTypeList")
                    return;
                string sQuery = "Select VchTypeID,VchType from tblVchType where ParentID=3 AND TenantID = '" + Global.gblTenantID + "'";
        ...
        private void chkVoucher_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string Sql = "Select VchTypeID,VchType from tblVchType where ParentID = 3 AND TenantID = '" + Global.gblTenantID + "'";
                    SqlConnection conn = new SqlConnection(constr);
                    conn.Open();
                    SqlCommand cmd = new SqlCommand(Sql, conn);
        ...
        private void rdoSalesDaybook_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //string Sql = "DROP VIEW vwpurchase";
                string Sql1 = "create view vwpurchase as select top 1 CCName as [Cost Center],Mop,VchType as [Voucher Type],Party,PartyCode as [Party Code] ,PartyAddress as [Party Address],PartyGSTIN as [Party GSTIN],BillType as [Bill Type],TaxAmt as [Tax Amount],GrossAmt as [Gross Amount],ItemDiscountTotal as [Item Discount Total],NonTaxable as [Non Taxable],Taxable,CGSTTotal as [CGST Total],SGSTTotal as[SGST Total],IGSTTotal as [IGST Total],CashDiscount as[Cash Discount],OtherExpense as [Other Expense],NetAmount as [Net Amount],RoundOff as [Round Off],BillAmt as [Bill Amount] from tblSales join tblSalesItem on tblSales.InvId = tblSalesItem.InvID join tblItemMaster on tblItemMaster.ItemID = tblSalesItem.ItemId join tblCostCentre on tblCostCentre.CCID=tblSales.CCID";
                SqlConnection conn = new SqlConnection(constr);
                conn.Open();
                //SqlCommand cmd = new SqlCommand(Sql, conn);
                SqlCommand cmd1 = new SqlCommand(Sql1, conn);
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DropPurchaseView();
                    string Fname = "Sales Return Daybook";
                ...
                if (rdoDaybookDetails.Checked == true)
                {
                    ...
                    string Fname = "Sales Return Daybook Details";
                ...
                if (rdbHsncode.Checked == true)
                {
                    ...
                    string Fname = "Sales Return Hsncode Wise";
                ...
                if (rdbItems.Checked == true)
                {
                    ...
                    string Fname = "Sales Return Item Wise";
                ...
                if (rdbTax.Checked == true)
                {
                    ...
                    string Fname = "Sales Return Tax split";
        ...
        private void rdoDaybookDetails_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                //string Sql = "DROP VIEW vwpurchase";
                //string Sql1 = "create view vwpurchase as select top 1 Mop,VchType,Party,PartyCode,PartyAddress,PartyGSTIN,BillType,ItemCode,ItemName,tblSalesItem.Qty,tblSalesItem.PRate,TaxAmt,GrossAmt,ItemDiscountTotal,NonTaxable,Taxable,CGSTTotal,SGSTTotal,IGSTTotal,FloodCessTot,CashDiscount,OtherExpense,NetAmount,RoundOff,BillAmt from tblSales join tblSalesItem on tblSales.InvId = tblSalesItem.InvID join tblItemMaster on tblItemMaster.ItemID = tblSalesItem.ItemId";

                string Sql1 = "create view vwpurchase as select top 1 CCName as [Cost Center],Mop,VchType as [Voucher Type],Party,PartyCode as [Party Code] ,PartyAddress as [Party Address],PartyGSTIN as [Party GSTIN],BillType as [Bill Type],ItemCode as [Item Code],ItemName as [Item Name],tblSalesItem.Qty as Qty,tblSalesItem.PRate as PRate,TaxAmt as [Tax Amount],GrossAmt as [Gross Amount],ItemDiscountTotal as [Item Discount Total],NonTaxable as [Non Taxable],Taxable,CGSTTotal as [CGST Total],SGSTTotal as[SGST Total],IGSTTotal as [IGST Total],CashDiscount as[Cash Discount],OtherExpense as [Other Expense],NetAmount as [Net Amount],RoundOff as [Round Off],BillAmt as [Bill Amount] from tblSales join tblSalesItem on tblSales.InvId = tblSalesItem.InvID join tblItemMaster on tblItemMaster.ItemID = tblSalesItem.ItemId join tblCostCentre on tblCostCentre.CCID=tblSales.CCID";
                SqlConnection conn = new SqlConnection(constr);
                conn.Open();
                //SqlCommand cmd = new SqlCommand(Sql, conn);
                SqlCommand cmd1 = new SqlCommand(Sql1, conn);
        ...
        private void rdbItems_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //string Sql = "DROP VIEW vwpurchase";
                string Sql1 = "create view vwpurchase as select top 1 ItemCode as [Item Code],ItemName as [Item Name],Category,Manufacturer,ProductType as [Product Type],tblSalesItem.Qty,tblSalesItem.PRate,tblSalesItem.MRP,ItemDiscount as [Item Discount],HSNID as HsnCode,TaxPer,NonTaxable as [Non Taxable],Taxable,GrossAmount as [Gross Amount],TaxAmount as [Tax Amount],NetAmount as [Net Amount] from tblSales join tblSalesItem on tblSales.InvId = tblSalesItem.InvID join tblItemMaster on tblItemMaster.ItemID = tblSalesItem.ItemId join tblCategories on tblCategories.CategoryID=tblItemMaster.CategoryID";
                SqlConnection conn = new SqlConnection(constr);
                conn.Open();
                //SqlCommand cmd = new SqlCommand(Sql, conn);
                SqlCommand cmd1 = new SqlCommand(Sql1, conn);
        ...
        private void rdbHsncode_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DropPurchaseView();
                //string Sql = "DROP VIEW vwpurchase";
                string Sql1 = "create view vwpurchase as select top 1 HSNID as HsnCode,tblSalesItem.Qty,tblSalesItem.PRate,tblSalesItem.MRP,ItemDiscount as [Item Discount],NonTaxable as [Non Taxable],Taxable,GrossAmount as [Gross Amount],TaxPer,TaxAmount as [Tax Amount],NetAmount from tblSales join tblSalesItem on tblSales.InvId = tblSalesItem.InvID join tblItemMaster on tblItemMaster.ItemID = tblSalesItem.ItemId";
                SqlConnection conn = new SqlConnection(constr);
                conn.Open();
                //SqlCommand cmd = new SqlCommand(Sql, conn);
                SqlCommand cmd1 = new SqlCommand(Sql1, conn);
