...
namespace DigiposZen
{
    ...
    public partial class frmPhysicalStock : Form, IMessageFilter
    {
        ...
        public frmPhysicalStock(int iVchTpeId = 0, int iTransID = 0, bool bFromEdit = false, object MDIParent = null)
        {
            InitializeComponent();
        ...
        private PhysicalStockGridColIndexes gridColIndexes = new PhysicalStockGridColIndexes();
                ...
                try
                {
                    if (IsValidate() == true)
                    {
                        ...
                        if (iAction == 1) // Edit
                        {
                            ...
                            sRetDet = clsPur.StockJournalDetailCRUD(clsPM, sqlConn, trans, "", 2);
                            sRetDet = clsPur.StockJournalDetailCRUD(clsPM, sqlConn, trans, "", 0);
                        }
                        else
                            sRetDet = clsPur.StockJournalDetailCRUD(clsPM, sqlConn, trans, "", iAction);
                        ...
                        if (sCompSearchData[0].ToString() != "")
                        {
                            ...
                            if (dtItemPublic.Rows.Count > 0)
                            {
                                if (dtItemPublic.Columns.Count > 11)
                                {
                                    ...
                                    //sBatchCode = dtItemPublic.Rows[0]["BatchUnique"].ToString();
        ...
        private void AddColumnsToGrid()
        {
            ...
            if (AppSettings.IsActiveMRP == true)
                this.dgvItems.Columns.Add(new DataGridViewTextBoxColumn() { Name = "cMRP", HeaderText = "" + AppSettings.MRPName + "", ReadOnly = true, Visible = true, Width = 80 }); //6
            else
                this.dgvItems.Columns.Add(new DataGridViewTextBoxColumn() { Name = "cMRP", HeaderText = "" + AppSettings.MRPName + "", ReadOnly = true, Visible = false, Width = 80 }); //6
            ...
            this.dgvItems.Columns.Add(new DataGridViewTextBoxColumn() { Name = "cQOH", HeaderText = "QOH", Visible = true, ReadOnly = true, Width = 80 }); //9
            ...
            this.dgvItems.Columns.Add(new DataGridViewTextBoxColumn() { Name = "cSRate1", HeaderText = "" + AppSettings.SRate1Name + "", ReadOnly = true, Visible = false, Width = 80 }); //11
            if (AppSettings.IsActiveSRate2 == true)
            {
                ...
                this.dgvItems.Columns.Add(new DataGridViewTextBoxColumn() { Name = "cSRate2", HeaderText = "" + AppSettings.SRate2Name + "", ReadOnly = true, Visible = false, Width = 80 }); //13
            }
            else
            {
                this.dgvItems.Columns.Add(new DataGridViewTextBoxColumn() { Name = "cSRate2Per", HeaderText = "" + AppSettings.SRate2Name + " %", ReadOnly = true, Visible = false, Width = 80 }); //12
            ...
            if (AppSettings.IsActiveSRate3 == true)
            {
                ...
                this.dgvItems.Columns.Add(new DataGridViewTextBoxColumn() { Name = "cSRate3", HeaderText = AppSettings.SRate3Name, ReadOnly = true, Visible = false, Width = 80 }); //15
            }
            else
            {
                this.dgvItems.Columns.Add(new DataGridViewTextBoxColumn() { Name = "cSRate3Per", HeaderText = "" + AppSettings.SRate3Name + " %", ReadOnly = true, Visible = false, Width = 80 }); //14
            ...
            if (AppSettings.IsActiveSRate4 == true)
            {
                ...
                this.dgvItems.Columns.Add(new DataGridViewTextBoxColumn() { Name = "cSRate4", HeaderText = AppSettings.SRate4Name, ReadOnly = true, Visible = false, Width = 80 }); //17
            }
            else
            {
                this.dgvItems.Columns.Add(new DataGridViewTextBoxColumn() { Name = "cSRate4Per", HeaderText = "" + AppSettings.SRate4Name + " %", ReadOnly = true, Visible = false, Width = 80 }); //16
            ...
            if (AppSettings.IsActiveSRate5 == true)
            {
                ...
                this.dgvItems.Columns.Add(new DataGridViewTextBoxColumn() { Name = "cSRate5", HeaderText = AppSettings.SRate5Name, ReadOnly = true, Visible = false, Width = 80 }); //19
            }
            else
            {
                this.dgvItems.Columns.Add(new DataGridViewTextBoxColumn() { Name = "cSRate5Per", HeaderText = "" + AppSettings.SRate5Name + " %", ReadOnly = true, Visible = false, Width = 80 }); //18
            ...
            this.dgvItems.Columns.Add(new DataGridViewImageColumn() { Name = "cBatchUnique", HeaderText="", Image = DigiposZen.Properties.Resources.Delete_24_P4, Width=40, Visible=false });
                    ...
                    if (dtGridSettings.Rows.Count > 0)
                    {
                        for (int k = 0; k < dtGridSettings.Rows.Count; k++)
                        {
                            if (dtGridSettings.Rows[k][3].ToString() == dgvItems.Columns[k].Name)
                            {
                                ...
                                else if (dgvItems.Columns[k].Name.ToUpper().Trim() == "CSRATE1PER" || dgvItems.Columns[k].Name.ToUpper().Trim() == "CSRATE1")
                                {
                                    dgvItems.Columns[k].Width = Convert.ToInt32(dtGridSettings.Rows[k][2].ToString());
                                    dgvItems.Columns[k].Visible = false;
                                }
                                else if (dgvItems.Columns[k].Name.ToUpper().Trim() == "CSRATE2PER" || dgvItems.Columns[k].Name.ToUpper().Trim() == "CSRATE2")
                                {
                                ...
                                else if (dgvItems.Columns[k].Name.ToUpper().Trim() == "CSRATE3PER" || dgvItems.Columns[k].Name.ToUpper().Trim() == "CSRATE3")
                                {
                                ...
                                else if (dgvItems.Columns[k].Name.ToUpper().Trim() == "CSRATE4PER" || dgvItems.Columns[k].Name.ToUpper().Trim() == "CSRATE4")
                                {
                                ...
                                else if (dgvItems.Columns[k].Name.ToUpper().Trim() == "CSRATE5PER" || dgvItems.Columns[k].Name.ToUpper().Trim() == "CSRATE5")
                                {
        ...
        private void frmPhysicalStock_Activated(object sender, EventArgs e)
        {
            try
            {
                LoadGridWidthFromItemGrid();
    ...
    public class PhysicalStockGridColIndexes
    {
        public int cSlNo = 0;
