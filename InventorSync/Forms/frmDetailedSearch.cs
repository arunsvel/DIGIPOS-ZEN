...
namespace DigiposZen.Forms
{
    public partial class frmDetailedSearch : Form
    {
        ...
        #region "EVENTS ------------------------------------------------ >>"
        private void frmDetailedSearch_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
        ...
        private void frmDetailedSearch_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Escape)
            {
                Boolean result = btnSearchClick("0|" + txtSearch.Text + "");
        ...
        private void frmDetailedSearch_Shown(object sender, EventArgs e)
        {
            txtSearch.Focus();
            txtSearch.Select(1, 1);
        }
