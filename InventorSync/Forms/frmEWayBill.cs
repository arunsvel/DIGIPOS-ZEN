...
namespace DigiposZen
{
    ...
    public partial class frmEWayBill : Form, IMessageFilter
    {
        ...
        public frmEWayBill(int iColorID = 0, bool bFromEdit = false, Control Controlpassed = null, bool blnDisableMinimize = false)
        {
        ...
        private void lblBrandshortname_Click(object sender, EventArgs e)
        {
