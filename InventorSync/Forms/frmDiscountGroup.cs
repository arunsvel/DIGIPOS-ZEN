        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (iIDFromEditWindow > 5)
                {
                    ...
                    {
                        DeleteData();
                        Comm.writeuserlog(Common.UserActivity.Delete_Entry, newdata, olddata, "Deleted " + DiscounGtroupinfo.DiscountGroupName, 521, 521, DiscounGtroupinfo.DiscountGroupName, Comm.ToInt32(DiscounGtroupinfo.DiscountGroupName), "Discount Group");
