    ...
    public partial class frmPurchaseReport : Form
    {
        ...
        private void txtVoucherTypeList_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (this.ActiveControl.Name != "txtVoucherTypeList")
                    return;
                string sQuery = "Select VchTypeID,VchType from tblVchType where ParentID=2 AND TenantID = '" + Global.gblTenantID + "'";
        ...
        private void chkVoucher_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string Sql = "Select VchTypeID,VchType from tblVchType where ParentID = 2 AND TenantID = '" + Global.gblTenantID + "'";
                    SqlConnection conn = new SqlConnection(constr);
                    conn.Open();
                    SqlCommand cmd = new SqlCommand(Sql, conn);
        ...
        private void txtSupplier_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                new frmCompactSearch(GetFromSupplierSearch, sQuery, "AnyWhere|LAliasName|LName|MobileNo|Address", txtSupplier.Location.X + 480, txtSupplier.Location.Y - 10, 4, 0, txtSupplier.Text, 4, 0, "ORDER BY L.LAliasName ASC", 0, 0, " Search ...", 0, "100,200,100,200,0", true, "frmSupplier").ShowDialog();
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                if (rdbHsncode.Checked == true)
                {
                    ...
                    string Fname = "Purchase Hsncode Wise";
                ...
                if (rdbItems.Checked == true)
                {
                    ...
                    string Fname = "Purchase Item Wise";
                ...
                if (rdbTax.Checked == true)
                {
                    ...
                    string Fname = "Purchase Tax split";
        ...
        private void rdoDaybookDetails_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                string Sql1 = "create view vwpurchase as select top 1 CCName as [Cost Center],Mop,VchType as [Voucher Type],Party,PartyCode as [Party Code] ,PartyAddress as [Party Address],PartyGSTIN as [Party GSTIN],BillType as [Bill Type],ItemCode as [Item Code],ItemName as [Item Name],tblPurchaseItem.Qty as Qty,tblPurchaseItem.PRate as PRate,TaxAmt as [Tax Amount],GrossAmount as [IGross Amount],ItemDiscountTotal as [Item Discount Total],InonTaxableAmount as [INon Taxable],Taxable,CGSTTotal as [CGST Total],SGSTTotal as[SGST Total],IGSTTotal as [IGST Total],CashDiscount as[Cash Discount],OtherExpense as [Other Expense],INetAmount as [Item Net Amount] from tblPurchase join tblPurchaseItem on tblPurchase.InvId = tblPurchaseItem.InvID join tblItemMaster on tblItemMaster.ItemID = tblPurchaseItem.ItemId join tblCostCentre on tblCostCentre.CCID=tblPurchase.CCID";
                SqlConnection conn = new SqlConnection(constr);
                conn.Open();
                SqlCommand cmd1 = new SqlCommand(Sql1, conn);
                cmd1.ExecuteNonQuery();
        ...
        private void rdbItems_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Sql1 = "create view vwpurchase as select top 1 ItemCode as [Item Code],ItemName as [Item Name],Category,Manufacturer,ProductType as [Product Type],tblPurchaseItem.Qty,tblPurchaseItem.PRate,tblPurchaseItem.MRP,ItemDiscount as [Item Discount],HSNID as HsnCode,TaxPer,InonTaxableAmount as [INon Taxable],ITaxableAmount,GrossAmount as [IGross Amount],TaxAmount as [ITax Amount],INetAmount as [Item Net Amount] from tblPurchase join tblPurchaseItem on tblPurchase.InvId = tblPurchaseItem.InvID join tblItemMaster on tblItemMaster.ItemID = tblPurchaseItem.ItemId join tblCategories on tblCategories.CategoryID=tblItemMaster.CategoryID";
                SqlConnection conn = new SqlConnection(constr);
                conn.Open();
                SqlCommand cmd1 = new SqlCommand(Sql1, conn);
                cmd1.ExecuteNonQuery();
        ...
        private void rdoPurchaseDaybook_CheckedChanged_1(object sender, EventArgs e)
        {
            try
            {
                chkfield.Visible = true;
