    ...
    public partial class frmDeliveryNote : Form
    {
        ...
        private void txtVoucherTypeList_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (this.ActiveControl.Name != "txtVoucherTypeList")
                    return;
                string sQuery = "Select VchTypeID,VchType from tblVchType where ParentID=5 AND TenantID = '" + Global.gblTenantID + "'";
        ...
        private void chkVoucher_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string Sql = "Select VchTypeID,VchType from tblVchType where ParentID = 5 AND TenantID = '" + Global.gblTenantID + "'";
                    SqlConnection conn = new SqlConnection(constr);
                    conn.Open();
                    SqlCommand cmd = new SqlCommand(Sql, conn);
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DropPurchaseView();
                    string Fname = "Delivery Note Daybook";
                ...
                if (rdoDaybookDetails.Checked == true)
                {
                    ...
                    string Fname = "Delivery Note Detail Daybook";
                ...
                if (rdbItems.Checked == true)
                {
                    ...
                    string Fname = "Delivery Note Item Wise";
