...
namespace InventorSync
{
    ...
    public partial class frmStockOutVoucherNew : Form, IMessageFilter
    {
        ...
        private void AddColumnsToGrid()
        {
            ...
            this.dgvSales.Columns.Add(new DataGridViewImageColumn() { Name = "cImgDel", HeaderText = "", Image = Properties.Resources.Delete_24_P4, Width = 40, ReadOnly = true });
            this.dgvSales.Columns.Add(new DataGridViewImageColumn() { Name = "cBatchUnique", HeaderText = "", Image = Properties.Resources.Delete_24_P4, Width = 40, Visible = false, ReadOnly = true });
