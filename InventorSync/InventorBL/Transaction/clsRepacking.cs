...
{
    public class clsRepacking : DBConnection
    {
        Common Comm = new Common();

        public string RepackingMasterCRUD(clsJSonRepacking clsPur, SqlConnection sqlConn, SqlTransaction trans, string strJson = "", int iAction = 0)
        {
            ...
            //{
                try
                {
                    using (SqlCommand sqlCmd = new SqlCommand("UspRepackingInsert", sqlConn, trans))
                    {
        ...
        //public string RepackingDetailCRUD(clsJSonRepacking clsPur, string sBatchCode = "", int iAction = 0)
        //{
        //    DataTable dtResult = new DataTable();
        //    string sResult = "";
        //    string sResultID = "";
        ...
        //            {
        //                using (SqlCommand sqlCmd = new SqlCommand("UspRepackingItemInsert", sqlConn))
        //                {
        //                    sqlCmd.CommandType = CommandType.StoredProcedure;
        //                    SqlParameter SpParam = new SqlParameter();
        ...
        public string RepackingDetailCRUD(clsJSonRepacking clsPur, SqlConnection sqlConn, SqlTransaction trans, string sBatchCode = "", int iAction = 0)
        {
            DataTable dtResult = new DataTable();
            ...
            //{
                try
                {
                    if (iAction == 0)
                    {
                        ...
                        {
                            using (SqlCommand sqlCmd = new SqlCommand("UspRepackingItemInsert", sqlConn, trans))
                            {
                                ...
                                SpParam = sqlCmd.Parameters.Add("@InvID", SqlDbType.Decimal);
                                SpParam.Value = clsPur.clsJsonPMInfo_.InvId; //Convert.ToDecimal(dbtl.Rows[i]["InvID"].ToString());
                                ...
                                SpParam = sqlCmd.Parameters.Add("@CRateWithTax", SqlDbType.Decimal);
                                SpParam.Value = Convert.ToDecimal(dbtl.Rows[i]["CRateWithTax"].ToString());
                            ...
                            if (dtResult.Rows.Count > 0)
                            {
                                if (dtResult.Rows[0].ItemArray[0].ToString().Replace(" ", "") == "-1")
                                {
                                    retResult = dtResult.Rows[0].ItemArray[0].ToString();
                                    if (dtResult.Rows[0].ItemArray.Count() > 3)
                                    {
                                        if (dtResult.Rows[0].ItemArray.Count() > 7)
                                            retResult += "|" + dtResult.Rows[0].ItemArray[4].ToString() + ";" + dtResult.Rows[0].ItemArray[5].ToString() + ";" + dtResult.Rows[0].ItemArray[6].ToString() + ";" + dtResult.Rows[0].ItemArray[7].ToString();
                                        else
                                            retResult += "|" + dtResult.Rows[0].ItemArray[4].ToString() + ";" + dtResult.Rows[0].ItemArray[5].ToString() + ";" + dtResult.Rows[0].ItemArray[6].ToString();
                                    }
                                }
                                else
                                {
                    ...
                    else if (iAction == 2)
                    {
                        using (SqlCommand sqlCmd = new SqlCommand("UspRepackingItemInsert", sqlConn, trans))
                        {
                            ...
                            SpParam = sqlCmd.Parameters.Add("@CRateWithTax", SqlDbType.Decimal);
                            SpParam.Value = Convert.ToDecimal(dbtl.Rows[0]["CRateWithTax"].ToString());
                            SpParam = sqlCmd.Parameters.Add("@Unit", SqlDbType.VarChar);
                        ...
                        //        if (dtResult.Rows[0].ItemArray.Count() > 3)
                        //        {
                        //            retResult += "|" + dtResult.Rows[0].ItemArray[4].ToString() + ";" + dtResult.Rows[0].ItemArray[5].ToString() + ";" + dtResult.Rows[0].ItemArray[6].ToString() + ";" + dtResult.Rows[0].ItemArray[8].ToString();
                        //        }
                        //    }
                    }
                }
                    else if (iAction == 3)
                    {
                        ...
                        //        if (dtResult.Rows[0].ItemArray.Count() > 3)
                        //        {
                        //            if (dtResult.Rows[0].ItemArray.Count() > 8)
                        //                retResult += "|" + dtResult.Rows[0].ItemArray[4].ToString() + ";" + dtResult.Rows[0].ItemArray[5].ToString() + ";" + dtResult.Rows[0].ItemArray[6].ToString() + ";" + dtResult.Rows[0].ItemArray[8].ToString();
                        //            else
                        //                retResult += "|" + dtResult.Rows[0].ItemArray[4].ToString() + ";" + dtResult.Rows[0].ItemArray[5].ToString() + ";" + dtResult.Rows[0].ItemArray[6].ToString() + ";" + dtResult.Rows[0].ItemArray[7].ToString();
                        //        }
        ...
        public DataTable GetRepackingMaster(UspGetRepackingInfo Info, bool blnIsPrevNext = false)
        {
            ...
            try
            {
                ...
                {
                    using (SqlDataAdapter sqlda = new SqlDataAdapter("UspGetRepackingMaster", sqlcon))
                    {
        ...
        public DataTable GetRepackingDetailItem(UspGetRepackingInfo Info)
        {
            DataTable dtbl = new DataTable();
            try
            {
                using (var sqlcon = GetDBConnection())
                {
                    using (SqlDataAdapter sqlda = new SqlDataAdapter("UspGetRepackingDetailItem", sqlcon))
                    {
                        sqlda.SelectCommand.CommandType = CommandType.StoredProcedure;
                        sqlda.SelectCommand.Parameters.Add("@InvID", SqlDbType.Decimal).Value = Info.InvId;
                        sqlda.Fill(dtbl);
