...
{
    public class UspLedgerInsertInfo
    {
        #region "Parameters--------------------------------------------------- >> "
        public decimal LID
        {
        ...
        public string DummyLName
        {
            get;
            set;
        }
        public decimal BlnBank
        {
            get;
            set;
        }
        ...
        public decimal blnBillWise
        {
            get;
            set;
        }
        public decimal CustomerCardID
        {
            get;
            set;
        }
        public decimal TDSPer
        {
            get;
            set;
        }
        ...
        public decimal BlnWallet
        {
            get;
            set;
        }
        public decimal blnCoupon
        {
            get;
            set;
        }
        public decimal TransComn
        {
            get;
            set;
        }
        public decimal BlnSmsWelcome
        {
            get;
            set;
        }
        ...
        public string LedgerNameUnicode
        {
            get;
            set;
        }
        public string LedgerAliasNameUnicode
        {
            get;
            set;
        }
        ...
        public string TaxParameter
        {
            get;
            set;
        }
        public string TaxParameterType
        {
            get;
            set;
        }
