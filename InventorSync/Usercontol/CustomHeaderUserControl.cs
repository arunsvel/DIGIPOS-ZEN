...
namespace MultiSelection
{
    ...
    internal class CustomHeaderUserControl : Panel
    {
...
#else
            pictureBox.Image = Image.FromFile(@"D:\# Latest Project\InventorSync\Inventor\InventorSync\InventorSync\Images\search_Colorful.png");
#endif
        ...
        /// <summary>
        /// Occurs while combobox drop down is closing.
        /// </summary>
        /// <param name="sender">The sender.</param>
